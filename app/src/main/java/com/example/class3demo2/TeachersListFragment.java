...
public class TeachersListFragment extends Fragment {
    List<Teacher> data = new LinkedList<Teacher>();
    View view;
    MyAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(int position, View v) {
                Teacher tc = data.get(position);
                Log.d("TAG","row was clicked " + position);
                TeachersListFragmentDirections.ActionTeachersListFragmentToTeacherDetailsFragment2 action = TeachersListFragmentDirections.actionTeachersListFragmentToTeacherDetailsFragment2(tc.getId());
                Navigation.findNavController(v).navigate(action);
            }
        });

        ImageButton addBtn = view.findViewById(R.id.studentlist_add_btn);
        addBtn.setOnClickListener(Navigation.createNavigateOnClickListener(TeachersListFragmentDirections.actionGlobalAddTeacherFragment()));
