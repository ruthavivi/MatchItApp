...
public class AddTeacherFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        idEt = view.findViewById(R.id.main_phone_et);
        ...
        cancelBtn.setOnClickListener(Navigation.createNavigateOnClickListener(AddTeacherFragmentDirections.actionGlobalSearchFragment()));
    ...
    private void save() {
        ...
        Teacher tc = new Teacher(name,id,flag);
        Model.instance.addTeacher(tc,()->{
